...
$(document).ready(function () {
    ...
    function optionsWindow() {
        ...
        var dialogTrigger = '<a class="cta forum" href="#tpcolorOptions">TipidPColor Options</a>';
