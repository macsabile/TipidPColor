...
$(document).ready(function () {
    ...
    function optionsWindow() {
        ...
        var globalCSS = '<style>#nav{padding: 15px 0 15px 10px;}#textNum{text-align: center;padding: 0;margin: 0;}div.alertbox {border:0;}input[type="button"] {border: none;cursor: pointer;padding: 5px 40px;font-weight: bold;}input[type="submit"] {border: none;cursor: pointer;padding: 7px 25px;font-weight: bold;}</style>';
